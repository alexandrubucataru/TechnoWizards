...
const LanguageSwitcher = {
  ...
  translations: {
    en: {
      ...
      customCode: 'Custom code written in Python/EV3 for autonomous performance',
      ...
      attachmentsText: 'To tackle different missions efficiently, we designed and 3D‑printed several interchangeable attachments using our in-house CAD and printer. Examples include:',
    ...
    ro: {
      ...
      customCode: 'Cod personalizat scris în Python/EV3 pentru performanță autonomă',
      ...
      attachmentsText: 'Pentru a aborda eficient diferitele misiuni, am proiectat și am tipărit în 3D mai multe atașamente interschimbabile folosind CAD-ul și imprimanta din interior. Exemple includ:',
